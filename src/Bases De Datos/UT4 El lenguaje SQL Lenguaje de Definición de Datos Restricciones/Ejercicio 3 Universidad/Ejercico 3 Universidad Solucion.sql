...
(
    ...
    CONSTRAINT CK_CODCARRERA CHECK (SUBSTR(CAST(CODCARRERA AS NUMBER(3)), 1, 1) = '1'),
    CONSTRAINT CK_CODASIG CHECK (SUBSTR(CAST(CODASIG AS NUMBER(3)), 1, 1) = '1')
/*CONSTRAINT CK_CODCARRERA CHECK (CODCARRERA >= 1),  --nose como hacer esto
CONSTRAINT CK_CODASIG CHECK (CODASIG >= 1)   -- esto solo verifica que el codigo sea positivo igual o mayor de uno*/
);
