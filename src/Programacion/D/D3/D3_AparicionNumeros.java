...
public class D3_AparicionNumeros {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < numeros.length; i++) {
            int cuenta = 0;
            for (int j = 0; j < numeros.length; j++) { // esto compara el indice 0 del array con todos los demas indices, si coincide suma 1 a cuenta. cuando termina el for J cambia el indice i a 1 y vuelve a comparar el indice 1 con todos los demas indices
