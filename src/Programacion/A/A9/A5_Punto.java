...
public class A5_Punto {
    ...
    A5_Punto distanciaAl0(A5_Punto punto, A5_Punto punto2) {
        double distancia1 = Math.sqrt(Math.pow((punto.x), 2) + Math.pow((punto.y), 2));
        double distancia2 = Math.sqrt(Math.pow((punto2.x), 2) + Math.pow((punto2.y), 2));
