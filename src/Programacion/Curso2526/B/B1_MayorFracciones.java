...
public class B1_MayorFracciones {
    ...
    public static void main(String[] args) {
        Programacion.Curso2526.B.B1_MayorFracciones f1 = new Programacion.Curso2526.B.B1_MayorFracciones(5, 12);
        Programacion.Curso2526.B.B1_MayorFracciones f2 = new Programacion.Curso2526.B.B1_MayorFracciones(2, 4);
        Programacion.Curso2526.B.B1_MayorFracciones fAux;
    ...
    Programacion.Curso2526.B.B1_MayorFracciones multiplicar(Programacion.Curso2526.B.B1_MayorFracciones fraccion) {
        Programacion.Curso2526.B.B1_MayorFracciones resultado = new Programacion.Curso2526.B.B1_MayorFracciones();
        resultado.numerador = this.numerador * fraccion.numerador;
        resultado.denominador = this.denominador * fraccion.denominador;
        return resultado;
    }

    Programacion.Curso2526.B.B1_MayorFracciones dividir(Programacion.Curso2526.B.B1_MayorFracciones fraccion) {
        Programacion.Curso2526.B.B1_MayorFracciones resultado = new Programacion.Curso2526.B.B1_MayorFracciones();
    ...
    Programacion.Curso2526.B.B1_MayorFracciones sumar(Programacion.Curso2526.B.B1_MayorFracciones fraccion) {
        Programacion.Curso2526.B.B1_MayorFracciones resultado = new Programacion.Curso2526.B.B1_MayorFracciones();
    ...
    Programacion.Curso2526.B.B1_MayorFracciones restar(Programacion.Curso2526.B.B1_MayorFracciones fraccion) {
        Programacion.Curso2526.B.B1_MayorFracciones resultado = new Programacion.Curso2526.B.B1_MayorFracciones();
        if (this.denominador == fraccion.denominador) {
            resultado.denominador = this.denominador;
            resultado.numerador = this.numerador - fraccion.numerador;
