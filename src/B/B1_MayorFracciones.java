...
public class B1_MayorFracciones {
    ...
    public static void main(String[] args) {
        B.B1_MayorFracciones f1 = new B.B1_MayorFracciones(5, 12);
        B.B1_MayorFracciones f2 = new B.B1_MayorFracciones(2, 4);
        B.B1_MayorFracciones fAux;
    ...
    B.B1_MayorFracciones multiplicar(B.B1_MayorFracciones fraccion) {
        B.B1_MayorFracciones resultado = new B.B1_MayorFracciones();
        resultado.numerador = this.numerador * fraccion.numerador;
        resultado.denominador = this.denominador * fraccion.denominador;
        return resultado;
    }

    B.B1_MayorFracciones dividir(B.B1_MayorFracciones fraccion) {
        B.B1_MayorFracciones resultado = new B.B1_MayorFracciones();
    ...
    B.B1_MayorFracciones sumar(B.B1_MayorFracciones fraccion) {
        B.B1_MayorFracciones resultado = new B.B1_MayorFracciones();
    ...
    B.B1_MayorFracciones restar(B.B1_MayorFracciones fraccion) {
        B.B1_MayorFracciones resultado = new B.B1_MayorFracciones();
        if (this.denominador == fraccion.denominador) {
            resultado.denominador = this.denominador;
            resultado.numerador = this.numerador - fraccion.numerador;
